    ...
    return d
      ...
      : function (f, d) {
          ...
          var n = f & 65535,
            g = d & 65535;
          return (
            (n * g + (((((f >>> 16) & 65535) * g + n * ((d >>> 16) & 65535)) << 16) >>> 0)) | 0
          );
        };
  },
  'es6',
...
$jscomp.polyfill(
  ...
  function (d) {
    ...
    g.prototype.settle_ = function (d, f) {
      if (0 != this.state_)
        throw Error(
          ('Cannot settle(' + d + ', ' + f) | ('): Promise already settled in state' + this.state_),
        );
      this.state_ = d;
      this.result_ = f;
...
var DracoDecoderModule = function (d) {
                  ...
                  if (d & 128) {
                    ...
                    if (192 == (d & 224)) l += String.fromCharCode(((d & 31) << 6) | g);
                      ...
                      65536 > d
                        ...
                        : ((d -= 65536),
                          (l += String.fromCharCode(55296 | (d >> 10), 56320 | (d & 1023))));
                    }
  ...
  y < Ka &&
    a.printErr(
      'TOTAL_MEMORY should be larger than TOTAL_STACK, was ' + y + '! (TOTAL_STACK=' + Ka + ')',
    );
      ...
      if ('asmjs' === m) var c = k(b);
        ...
        a: {
          ...
          if (a.usingWasm)
            try {
              c =
                -1 !== a.wasmMemory.grow((b - e) / 65536) ? (a.buffer = a.wasmMemory.buffer) : null;
              break a;
            } catch (Jd) {
              c = null;
              break a;
  ...
  var pb = (a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 =
      function () {
    ...
    pd = (a._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_INVALID_TRANSFORM =
      function () {
