...
define([
  ...
  OrthographicOffCenterFrustum.prototype.computeCullingVolume = function (position, direction, up) {
    ...
    plane.y = -direction.y;
    plane.z = -direction.z;
    plane.w = -Cartesian2.Cartesian3.dot(
      Cartesian2.Cartesian3.negate(direction, negateScratch),
      point,
    );
  ...
  OrthographicFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
    ...
    return (
      _Math.CesiumMath.equalsEpsilon(this.width, other.width, relativeEpsilon, absoluteEpsilon) &&
      _Math.CesiumMath.equalsEpsilon(
        this.aspectRatio,
        other.aspectRatio,
        relativeEpsilon,
  ...
  PerspectiveFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
    ...
    return (
      _Math.CesiumMath.equalsEpsilon(this.fov, other.fov, relativeEpsilon, absoluteEpsilon) &&
      _Math.CesiumMath.equalsEpsilon(
        this.aspectRatio,
        other.aspectRatio,
        relativeEpsilon,
