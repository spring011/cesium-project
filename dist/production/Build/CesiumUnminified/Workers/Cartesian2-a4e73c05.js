...
define(['exports', './when-c2e8ef35', './Check-c4f3a3fc', './Math-a06249ed'], function (
  exports,
  when,
  Check,
  _Math,
  ...
  Rectangle.fromCartographicArray = function (cartographics, result) {
    ...
    for (var i = 0, len = cartographics.length; i < len; i++) {
      ...
      var lonAdjusted =
        position.longitude >= 0 ? position.longitude : position.longitude + _Math.CesiumMath.TWO_PI;
  ...
  Rectangle.MAX_VALUE = Object.freeze(
    new Rectangle(-Math.PI, -_Math.CesiumMath.PI_OVER_TWO, Math.PI, _Math.CesiumMath.PI_OVER_TWO),
  );
  ...
  Cartesian2.equals = function (left, right) {
    return (
      left === right ||
      (when.defined(left) && when.defined(right) && left.x === right.x && left.y === right.y)
    );
  };
