(function (global, factory) {
  ...
  function rotate(viewModel, compassElement, cursorVector) {
    ...
    if (defined$6(viewModel.terria.trackedEntity)) {
      ...
      if (
        ...
        (scene.mode === SceneMode$2.COLUMBUS_VIEW && !sscc.enableLook && !sscc.enableTranslate)
      ) {
  ...
  function initialize(viewerCesiumWidget, options) {
    ...
    if (
      ...
      (!defined$7(this.terria.options.enableCompass) || this.terria.options.enableCompass)
    ) {
