define([
  ...
  './CylinderGeometryLibrary-95411284',
], function (h, e, t, v, A, i, r, R, G, O, V, C, L) {
  'use strict';
  var g = new v.Cartesian2();
  function f(e) {
    var t = (e = h.defaultValue(e, h.defaultValue.EMPTY_OBJECT)).length,
      i = e.topRadius,
      r = e.bottomRadius,
      a = h.defaultValue(e.slices, 128),
      n = Math.max(h.defaultValue(e.numberOfVerticalLines, 16), 0);
    (this._length = t),
      (this._topRadius = i),
  ...
  return (
    ...
    (f.createGeometry = function (e) {
      ...
      if (!(t <= 0 || i < 0 || r < 0 || (0 === i && 0 === r))) {
        var o,
          u = 2 * a,
          s = L.CylinderGeometryLibrary.computePositions(t, i, r, a, !1),
          f = 2 * a;
        if (0 < n) {
          var d = Math.min(n, a);
        ...
        var l,
          m = V.IndexDatatype.createTypedArray(u, 2 * f),
          b = 0;
        for (l = 0; l < a - 1; l++)
          (m[b++] = l), (m[b++] = l + 1), (m[b++] = l + a), (m[b++] = l + 1 + a);
        if (((m[b++] = a - 1), (m[b++] = 0), (m[b++] = a + a - 1), (m[b++] = a), 0 < n))
          for (l = 0; l < a; l += o) (m[b++] = l), (m[b++] = l + a);
        ...
        if (h.defined(e._offsetAttribute)) {
          t = s.length;
          var y = new Uint8Array(t / 3),
            _ = e._offsetAttribute === C.GeometryOffsetAttribute.NONE ? 0 : 1;
          C.arrayFill(y, _),
            (c.applyOffset = new G.GeometryAttribute({
