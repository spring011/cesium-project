define([
  ...
  (E.wrapLongitude = function (a, e) {
    ...
    if (T.defined(a) && 0 < a.length) {
      ...
      var i = v.Matrix4.inverseTransformation(e, S),
        n = v.Matrix4.multiplyByPoint(i, P.Cartesian3.ZERO, b),
  ...
  (E.generateRhumbArc = function (a) {
    ...
    (E.generateCartesianArc = function (a) {
      for (var e = E.generateArc(a), r = e.length / 3, t = new Array(r), i = 0; i < r; i++)
        t[i] = P.Cartesian3.unpack(e, 3 * i);
      return t;
    }),
    (E.generateCartesianRhumbArc = function (a) {
      for (var e = E.generateRhumbArc(a), r = e.length / 3, t = new Array(r), i = 0; i < r; i++)
        t[i] = P.Cartesian3.unpack(e, 3 * i);
      return t;
    }),
