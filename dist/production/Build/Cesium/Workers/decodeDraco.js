define([
  ...
  function l(e, r, t) {
    ...
    b.destroy(i),
      (i = new b.AttributeOctahedronTransform()).InitFromAttribute(t) &&
  ...
  function a(e) {
    ...
    var a = e.bufferView,
      o = new b.DecoderBuffer();
    if ((o.Init(e.array, a.byteLength), r.GetEncodedGeometryType(o) !== b.TRIANGULAR_MESH))
      throw new m.RuntimeError('Unsupported draco mesh geometry type.');
    var i = new b.Mesh(),
      u = r.DecodeBufferToMesh(o, i);
    if (!u.ok() || 0 === i.ptr)
      throw new m.RuntimeError('Error decoding draco mesh geometry: ' + u.error_msg());
    b.destroy(o);
    var s = {},
    ...
    for (var c in d)
      if (d.hasOwnProperty(c)) {
        var f = d[c],
          y = r.GetAttributeByUniqueId(i, f);
        s[c] = l(i, r, y);
      }
    var A = {
      indexArray: (function (e, r) {
        for (
          var t = e.num_points(),
            n = e.num_faces(),
            a = new b.DracoInt32Array(),
            o = 3 * n,
            i = w.IndexDatatype.createTypedArray(t, o),
            u = 0,
            s = 0;
          s < n;
          ++s
  ...
  function o(e) {
    return (
      y.defined(e.primitive)
        ? a
        : function (e) {
            var r = new b.Decoder();
            e.dequantizeInShader &&
              (r.SkipAttributeTransform(b.POSITION), r.SkipAttributeTransform(b.NORMAL));
            var t = new b.DecoderBuffer();
            if ((t.Init(e.buffer, e.buffer.length), r.GetEncodedGeometryType(t) !== b.POINT_CLOUD))
              throw new m.RuntimeError('Draco geometry type must be POINT_CLOUD.');
            var n = new b.PointCloud(),
              a = r.DecodeBufferToPointCloud(t, n);
            if (!a.ok() || 0 === n.ptr)
              throw new m.RuntimeError('Error decoding draco point cloud: ' + a.error_msg());
            b.destroy(t);
            var o = {},
              i = e.properties;
            for (var u in i)
              if (i.hasOwnProperty(u)) {
                var s = i[u],
                  d = r.GetAttributeByUniqueId(n, s);
                o[u] = l(n, r, d);
              }
  ...
  return function (e) {
    ...
    if (y.defined(r))
      return require([r.modulePath], function (e) {
        y.defined(r.wasmBinaryFile)
          ? (y.defined(e) || (e = self.DracoDecoderModule),
            e(r).then(function (e) {
              i(e);
            }))
          : i(e());
