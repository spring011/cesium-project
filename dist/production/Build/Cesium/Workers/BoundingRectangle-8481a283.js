define([
  ...
  'use strict';
  function x(t, e, n, i) {
    (this.x = o.defaultValue(t, 0)),
      (this.y = o.defaultValue(e, 0)),
      (this.width = o.defaultValue(n, 0)),
      (this.height = o.defaultValue(i, 0));
  }
  (x.packedLength = 4),
    ...
    (x.fromPoints = function (t, e) {
      if ((o.defined(e) || (e = new x()), !o.defined(t) || 0 === t.length))
  ...
  (x.fromRectangle = function (t, e, n) {
    if ((o.defined(n) || (n = new x()), !o.defined(t)))
    ...
    return (
      r.Cartesian2.subtract(h, i, h), (n.x = i.x), (n.y = i.y), (n.width = h.x), (n.height = h.y), n
    );
  }),
    ...
    (x.intersect = function (t, e) {
      var n = t.x,
        ...
        h = e.x,
        r = e.y;
      return n > h + e.width || n + t.width < h || i + t.height < r || i > r + e.height
        ? a.Intersect.OUTSIDE
