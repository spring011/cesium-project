define([
...
], function (a, e, t, c, p, r, n, s, u, d, o, m, i, f, y, l, g, b, h, P, G, v, L, C, T) {
  'use strict';
  function E(e) {
    for (
      var t = e.length,
  ...
  function k(e) {
    ...
    (this._polygonHierarchy = t),
      ...
      (this.packedLength = T.PolygonGeometryLibrary.computeHierarchyPackedLength(t) + 1);
  }
  (k.fromPositions = function (e) {
    ...
    (k.pack = function (e, t, r) {
      return (
        ...
        (t[(r = T.PolygonGeometryLibrary.packPolygonHierarchy(e._polygonHierarchy, t, r))] =
          e.packedLength),
        t
      );
    });
  ...
  return (
    ...
    (k.createGeometry = function (e) {
      var t = e._polygonHierarchy,
        r = t.positions;
      if (
        !((r = b.arrayRemoveDuplicates(r, c.Cartesian3.equalsEpsilon, !0)).length < 3) &&
        ...
        if (0 !== n.length) {
          ...
          var y = m.GeometryPipeline.combineInstances(o)[0],
            l = p.BoundingSphere.fromPoints(t.positions);
