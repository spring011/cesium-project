define([
  ...
  M.getScale = function (e, t) {
    return (
      (t.x = O.Cartesian2.magnitude(O.Cartesian2.fromElements(e[0], e[1], i))),
      (t.y = O.Cartesian2.magnitude(O.Cartesian2.fromElements(e[2], e[3], i))),
      t
    );
  };
  ...
  var o = {
    ...
    s = Object.freeze(o);
  function f(e) {
    (e = a.defaultValue(e, a.defaultValue.EMPTY_OBJECT)),
      (this.attributes = e.attributes),
      (this.indices = e.indices),
      (this.primitiveType = a.defaultValue(e.primitiveType, s.TRIANGLES)),
      (this.boundingSphere = e.boundingSphere),
      (this.geometryType = a.defaultValue(e.geometryType, r.NONE)),
  ...
  (f._textureCoordinateRotationPoints = function (e, t, n, r) {
    ...
    for (a = 0; a < 3; a++)
      O.Cartographic.toCartesian(c[a], n, l),
        ...
        (f[a].x = l.x),
        (f[a].y = l.y);
    var d = v.Quaternion.fromAxisAngle(O.Cartesian3.UNIT_Z, -t, F),
    ...
    for (a = 0; a < m; a++)
      (l = v.Matrix4.multiplyByPointAsVector(s, e[a], l)),
        (l = v.Matrix3.multiplyByVector(y, l, l)),
        (p = Math.min(p, l.x)),
        (h = Math.min(h, l.y)),
        (N = Math.max(N, l.x)),
        (I = Math.max(I, l.y));
    var C = M.fromRotation(t, Y),
      b = W;
    ...
    (e.GeometryAttribute = function (e) {
      (e = a.defaultValue(e, a.defaultValue.EMPTY_OBJECT)),
        ...
        (this.normalize = a.defaultValue(e.normalize, !1)),
