define([
    ...
    function i(e, t, r, a, i, n, s) {
      for (var o, u = -1, p = -1, d = 0; d < r.length; ) {
        ...
        a[l].numLiveTriangles &&
          ((o = 0),
          i - a[l].timeStamp + 2 * a[l].numLiveTriangles <= t && (o = i - a[l].timeStamp),
          (p < o || -1 === p) && ((p = o), (u = l))),
          ++d;
      }
      return -1 === u
    ...
    (r.reorderForPreVertexCache = function (e) {
      ...
      if (_.defined(r)) {
        ...
        for (
          ...
          -1 !== (n = a[s[p]]) ? (u[d] = n) : ((a[(n = s[p])] = l), (u[d] = l), ++l), ++p, ++d;
        e.indices = u;
        var v = e.attributes;
        for (var y in v)
          if (v.hasOwnProperty(y) && _.defined(v[y]) && _.defined(v[y].values)) {
            for (
              var f = v[y],
                c = f.values,
                m = 0,
                C = f.componentsPerAttribute,
                h = M.ComponentDatatype.createTypedArray(f.componentDatatype, l * C);
              m < t;
  ...
  r.transformToWorldCoordinates = function (e) {
    ...
    return (
      _.defined(a) && (e.geometry.boundingSphere = Y.BoundingSphere.transform(a, t, a)),
    ...
    var r,
      ...
      y = (function (e, t) {
        var r,
          ...
          n = e[0][t].attributes;
        for (r in n)
          if (n.hasOwnProperty(r) && _.defined(n[r]) && _.defined(n[r].values)) {
    ...
    for (r in y)
      if (y.hasOwnProperty(r))
        for (s = y[r].values, a = n = 0; a < d; ++a)
          for (u = (o = e[a][t].attributes[r].values).length, i = 0; i < u; ++i) s[n++] = o[i];
    if (l) {
      var f = 0;
      for (a = 0; a < d; ++a) f += e[a][t].indices.length;
      var c = G.Geometry.computeNumberOfVertices(
          new G.Geometry({ attributes: y, primitiveType: G.PrimitiveType.POINTS }),
        ),
  ...
  r.combineInstances = function (e) {
    for (var t = [], r = [], a = e.length, i = 0; i < a; ++i) {
      ...
      _.defined(n.geometry)
        ? t.push(n)
        : _.defined(n.westHemisphereGeometry) && _.defined(n.eastHemisphereGeometry) && r.push(n);
    }
    var s = [];
    return (
  ...
  r.computeNormal = function (e) {
    ...
    for (t = 0; t < n; t++) {
      ...
      if (((C = o[t]), U.Cartesian3.clone(U.Cartesian3.ZERO, T), 0 < C.count)) {
        ...
        U.Cartesian3.equalsEpsilon(U.Cartesian3.ZERO, T, q.CesiumMath.EPSILON10) &&
          U.Cartesian3.clone(u[p[C.indexOffset]], T);
      }
      U.Cartesian3.equalsEpsilon(U.Cartesian3.ZERO, T, q.CesiumMath.EPSILON10) && (T.z = 1),
    ...
    for (t = 0; t < r; ++t) {
      ...
      p && _.defined(y) && _.defined(f)
        ? (U.Cartesian3.fromArray(l, x, D),
          ...
          (A[T++] = z.y))
        : (p &&
            (U.Cartesian3.fromArray(l, x, D), (A[T++] = P.AttributeCompression.octEncodeFloat(D))),
          C &&
            (U.Cartesian3.fromArray(y, x, D), (A[T++] = P.AttributeCompression.octEncodeFloat(D))),
          h &&
            (U.Cartesian3.fromArray(f, x, D), (A[T++] = P.AttributeCompression.octEncodeFloat(D))));
    }
    return (
      (e.attributes.compressedAttributes = new G.GeometryAttribute({
        componentDatatype: M.ComponentDatatype.FLOAT,
    ...
    if (!(0 <= e.x || 0 <= t.x || 0 <= r.x)) {
      ...
      1 == s
        ? ((o[1] = 3),
          ...
          (o[8] = 5),
          a
            ? (A(e, t, W, j), A(e, r, X, J), (o[0] = 0), (o[3] = 1), (o[4] = 2), (o[6] = 1))
            : i
              ? (A(t, r, W, j), A(t, e, X, J), (o[0] = 1), (o[3] = 2), (o[4] = 0), (o[6] = 2))
              : n && (A(r, e, W, j), A(r, t, X, J), (o[0] = 2), (o[3] = 0), (o[4] = 1), (o[6] = 0)))
        : 2 == s &&
          ((o[2] = 4),
          (o[4] = 4),
          (o[5] = 3),
          ...
          a
            ? i
              ? n || (A(r, e, W, j), A(r, t, X, J), (o[0] = 0), (o[1] = 1), (o[3] = 0), (o[6] = 2))
              : (A(t, r, W, j), A(t, e, X, J), (o[0] = 2), (o[1] = 0), (o[3] = 2), (o[6] = 1))
            : (A(e, t, W, j), A(e, r, X, J), (o[0] = 1), (o[1] = 2), (o[3] = 1), (o[6] = 0)));
      var u = K.positions;
      return (
        (u[0] = e),
        (u[1] = t),
        (u[2] = r),
        (u.length = 3),
        (1 != s && 2 != s) || ((u[3] = W), (u[4] = X), (u[5] = j), (u[6] = J), (u.length = 7)),
        K
      );
    }
  }
  ...
  function ce(e) {
    ...
    for (m = 0; m < T; m += 3) {
      ...
      if (_.defined(E) && 3 < E.positions.length)
        for (var N = E.positions, L = E.indices, z = L.length, D = 0; D < z; ++D) {
          var M = L[D],
            G = N[M];
          (c =
            G.y < 0
            ...
            le(x, P, w, G, a, i, s, n, o, u, p, y, l, C, r, ye(y, f, c, d, M < 3 ? m + M : -1, G));
        }
      else
        _.defined(E) && ((S = E.positions[0]), (I = E.positions[1]), (O = E.positions[2])),
          (c =
            S.y < 0
              ? ((y = b.attributes), (f = b.indices), g)
              : ((y = h.attributes), (f = h.indices), A)),
          le(x, P, w, S, a, i, s, n, o, u, p, y, l, C, r, ye(y, f, c, d, m, S)),
          le(x, P, w, I, a, i, s, n, o, u, p, y, l, C, r, ye(y, f, c, d, m + 1, I)),
          le(x, P, w, O, a, i, s, n, o, u, p, y, l, C, r, ye(y, f, c, d, m + 2, O));
    }
    te(e, b, h);
  }
  ...
  function ge(e) {
    ...
    for (t = 0; t < p; t += 2) {
      ...
      Math.abs(f.y) < q.CesiumMath.EPSILON6 &&
        (f.y < 0 ? (f.y = -q.CesiumMath.EPSILON6) : (f.y = q.CesiumMath.EPSILON6)),
        Math.abs(c.y) < q.CesiumMath.EPSILON6 &&
          (c.y < 0 ? (c.y = -q.CesiumMath.EPSILON6) : (c.y = q.CesiumMath.EPSILON6));
      var m = o.attributes,
        C = o.indices,
        h = l,
        b = u.attributes,
            ...
            for (t = 0; t < c; t += 4) {
              ...
              if (_.defined(P)) {
                ...
                g.position.values.push(h.x, h.y, h.z, h.x, h.y, h.z),
                  ...
                  T.nextPosition.values.push(u[3 * C], u[3 * C + 1], u[3 * C + 2]),
                  T.nextPosition.values.push(u[3 * C + 3], u[3 * C + 4], u[3 * C + 5]);
                ...
                if (
                  ((E /= U.Cartesian3.magnitudeSquared(U.Cartesian3.subtract(b, h, we))),
                  _.defined(l))
                ) {
                ...
                var B, k;
                for (
                  k = h.y < 0 ? ((B = y.attributes), y.indices) : ((B = v.attributes), v.indices),
                  ...
                  B.prevPosition.values.push(o[r]), B.nextPosition.values.push(u[r]);
                for (r = 2 * t; r < 2 * t + 8; ++r)
                  B.expandAndWidth.values.push(p[r]), _.defined(d) && B.st.values.push(d[r]);
