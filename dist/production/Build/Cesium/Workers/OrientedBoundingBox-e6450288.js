  ...
  (T.fromRectangle = function (a, t, e, n, r) {
    ...
    if (
      ...
      return (
        ...
        (b = n.cartographicToCartesian(p, ea)),
        (N = n.cartographicToCartesian(w, ra)),
        (c = Math.min(Z.Plane.getPointDistance(d, b), Z.Plane.getPointDistance(d, N))),
        (u = e),
    ...
    V.z = 0;
    var B =
        Math.abs(V.x) < X.CesiumMath.EPSILON10 && Math.abs(V.y) < X.CesiumMath.EPSILON10
          ? j.Cartesian3.UNIT_X
    ...
    (T.clone = function (a, t) {
      if (q.defined(a))
        return q.defined(t)
          ? (j.Cartesian3.clone(a.center, t.center), A.Matrix3.clone(a.halfAxes, t.halfAxes), t)
