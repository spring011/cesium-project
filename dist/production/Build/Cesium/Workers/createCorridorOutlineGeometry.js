define([
...
], function (R, e, c, B, g, t, i, U, F, Y, q, r, o, E, b, a, n, C, W, s, l, J) {
  'use strict';
  ...
  function G(e, t) {
    ...
    for (u += 3, p += 3, r = 0; r < s.length; r++) {
      ...
      R.defined(h) ? (u += o = h.length) : (p += o = s[r].rightPositions.length),
        (f += (o / 3) * 2);
    }
    var y,
      c = R.defined(l);
    ...
    var k = 0,
      ...
      O = n[k++];
    for (
      C.set(N, G), C.set(O, T - O.length + 1), o = O.length - 3, a.push(G / 3, (T - 2) / 3), r = 0;
      r < o;
      r += 3
    )
      (v = (b = G / 3) + 1),
    ...
    if (c) {
      ...
      var M = l[1];
      for (r = 0; r < P; r++)
        (_ = B.Cartesian3.fromArray(M, 3 * (y - r - 1), _)),
  ...
  function h(e) {
    ...
    (this._positions = t),
      (this._ellipsoid = B.Ellipsoid.clone(R.defaultValue(e.ellipsoid, B.Ellipsoid.WGS84))),
      (this._width = i),
      ...
      (this._granularity = R.defaultValue(e.granularity, c.CesiumMath.RADIANS_PER_DEGREE)),
      (this._offsetAttribute = e.offsetAttribute),
      (this._workerName = 'createCorridorOutlineGeometry'),
      (this.packedLength = 1 + t.length * B.Cartesian3.packedLength + B.Ellipsoid.packedLength + 6);
  }
  ...
  var y = B.Ellipsoid.clone(B.Ellipsoid.UNIT_SPHERE),
    m = {
      positions: void 0,
      ellipsoid: y,
      width: void 0,
  ...
  return (
    (h.unpack = function (e, t, i) {
      ...
      for (var r = e[t++], o = new Array(r), a = 0; a < r; ++a, t += B.Cartesian3.packedLength)
    ...
    (h.createGeometry = function (e) {
      ...
      if (!(o.length < 2 || i <= 0)) {
        var a,
          n = e._height,
          s = e._extrudedHeight,
          l = !c.CesiumMath.equalsEpsilon(n, s, 0, c.CesiumMath.EPSILON2),
          d = {
            ellipsoid: r,
            positions: o,
            width: i,
