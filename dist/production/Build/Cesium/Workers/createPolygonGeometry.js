define([
  ...
  './BoundingRectangle-8481a283',
  './EllipsoidTangentPlane-30395e74',
  './ArcType-29cf2197',
  './EllipsoidRhumbLine-5134246a',
  './PolygonPipeline-84f0d07f',
  './PolygonGeometryLibrary-0de16e21',
  './EllipsoidGeodesic-19bdf744',
], function (Y, e, U, j, Q, t, r, q, K, a, o, D, i, L, n, s, Z, v, N, l, u, H, c, p, R, M, y) {
  'use strict';
  ...
  function B(e) {
    ...
    if (t.st || t.normal || t.tangent || t.bitangent || a) {
      ...
      if (0 !== y) {
        ...
        (I = Q.Matrix3.clone(Q.Matrix3.IDENTITY, I)), (A = Q.Matrix3.clone(Q.Matrix3.IDENTITY, A));
      var G = 0,
        O = 0;
      s && l && ((G = i / 2), (O = i / 3), (i /= 2));
      for (var V = 0; V < i; V += 3) {
        ...
        if (t.normal || t.tangent || t.bitangent || a) {
          ...
          if (n) {
            ...
            (t.tangent || t.bitangent) &&
              ((x = c.geodeticSurfaceNormal(F, x)),
              t.tangent && (w = j.Cartesian3.normalize(j.Cartesian3.cross(x, C, w), w)));
          } else
            (C = c.geodeticSurfaceNormal(F, C)),
              (t.tangent || t.bitangent) &&
                (m &&
                  ((oe = j.Cartesian3.fromArray(d, P, oe)),
                  (ie = j.Cartesian3.cross(j.Cartesian3.UNIT_Z, oe, ie)),
                  (ie = j.Cartesian3.normalize(Q.Matrix3.multiplyByVector(A, ie, ie), ie)),
                  t.bitangent && (ne = j.Cartesian3.normalize(j.Cartesian3.cross(oe, ie, ne), ne))),
                (w = j.Cartesian3.cross(j.Cartesian3.UNIT_Z, C, w)),
                (w = j.Cartesian3.normalize(Q.Matrix3.multiplyByVector(A, w, w), w)),
                t.bitangent && (x = j.Cartesian3.normalize(j.Cartesian3.cross(C, w, x), x)));
          t.normal &&
            (e.wall
            ...
            a &&
              (n && (C = c.geodeticSurfaceNormal(F, C)),
              (b[P + G] = -C.x),
              (b[R + G] = -C.y),
              (b[M + G] = -C.z)),
            t.tangent &&
              (e.wall
                ...
                : l && ((f[P + G] = -w.x), (f[R + G] = -w.y), (f[M + G] = -w.z)),
              s &&
                (m
  ...
  function _(e, t, r, a, o) {
    if (((o = Y.defaultValue(o, new j.Rectangle())), !Y.defined(e) || e.length < 3))
  ...
  function k(e, t, r, a, o, i, n, s, l) {
    ...
    if (i || n) {
      var c,
        y,
        m = M.PolygonGeometryLibrary.createGeometryFromPositions(e, t, r, o, s, l),
      ...
      if (i && n) {
        ...
        for (
          c = g.length / 3, y = L.IndexDatatype.createTypedArray(c, d.length), u = 0;
          u < d.length;
          u += 3
        )
    ...
    for (u = 0; u < E.length; u++) {
      var G = E[u];
      (T = (x = H.EllipsoidTangentPlane.fromPoints(G, e)).projectPointsOntoPlane(G, O)),
        (I = R.PolygonPipeline.computeWindingOrder2D(T)) === R.WindingOrder.COUNTER_CLOCKWISE &&
          (G = G.slice().reverse()),
  ...
  function w(e) {
    ...
    (this._vertexFormat = v.VertexFormat.clone(r)),
      ...
      (this._arcType = Y.defaultValue(e.arcType, c.ArcType.GEODESIC)),
  ...
  (w.fromPositions = function (e) {
    return new w({
      polygonHierarchy: {
        positions: (e = Y.defaultValue(e, Y.defaultValue.EMPTY_OBJECT)).positions,
      },
      height: e.height,
    ...
    (w.pack = function (e, t, r) {
      return (
        ...
        (r = M.PolygonGeometryLibrary.packPolygonHierarchy(e._polygonHierarchy, t, r)),
  ...
  return (
    ...
    (w.computeRectangle = function (e, t) {
      var r = Y.defaultValue(e.granularity, U.CesiumMath.RADIANS_PER_DEGREE),
        a = Y.defaultValue(e.arcType, c.ArcType.GEODESIC),
          ...
          if (
            ...
            for (
              ...
              s && l
                ...
                : s
                  ? (((P = C.topAndBottom).geometry.attributes.position.values =
                      R.PolygonPipeline.scaleToGeodeticHeight(
            ...
            for (d = 0; d < g.length; d++) {
              var I = new N.GeometryInstance({
                geometry: M.PolygonGeometryLibrary.createGeometryFromPositions(r, g[d], a, n, t, u),
              });
              if (
