define([
  ...
  Ce.getRegularGridIndicesAndEdgeIndices = function (e, t) {
    ...
    var n = r[t];
    if (!Te.defined(n)) {
      var i = Ce.getRegularGridIndices(e, t),
        o = T(e, t),
  ...
  (Ce.getRegularGridAndSkirtIndicesAndEdgeIndices = function (e, t) {
    ...
    if (!Te.defined(n)) {
      ...
      p(e, t, m, 0),
        Ce.addSkirtIndices(u, h, l, I, i, m, o),
        (n = r[t] =
          {
            indices: m,
    ...
    (Ce.heightmapTerrainQuality = 0.25),
    (Ce.getEstimatedLevelZeroGeometricErrorForAHeightmap = function (e, t, r) {
  ...
  function _e(e, t, r, n, i, o, a, s, d, c, u, h, l, I, m) {
    ...
    for (var v = r.length, y = 0; y < v; ++y) {
      ...
      (We.longitude = pe.CesiumMath.lerp(E, f, x.x) + I),
        ...
        (We.height = w - c);
      var M,
        C = s.cartographicToCartesian(We, Se);
      if (g) {
        var b = 2 * N;
      ...
      n.hasWebMercatorT &&
        (M = (Ne.WebMercatorProjection.geodeticLatitudeToMercatorAngle(We.latitude) - h) * l),
        (t = n.encode(e, t, C, x, We.height, De, M));
    }
  }
  function He(e, t) {
    var r;
  ...
  return a(function (e, t) {
    ...
    d &&
      ...
      (n = 1 / (Ne.WebMercatorProjection.geodeticLatitudeToMercatorAngle(I) - r)));
    ...
    for (
      ...
      var V = y[k],
        ...
        H = V / be,
        O = _ / be,
        G = pe.CesiumMath.lerp(T, p, w[k] / be);
      ...
      (M[k] = new fe.Cartesian2(H, O)),
        ...
        (b[k] = Y),
        d &&
          (S[k] = (Ne.WebMercatorProjection.geodeticLatitudeToMercatorAngle(We.latitude) - r) * n),
    ...
    1 !== g &&
      ((R = Ee.BoundingSphere.fromPoints(b)),
      (z = xe.OrientedBoundingBox.fromRectangle(c, T, p, m))),
      (1 !== g || T < 0) &&
        (L = new Me.EllipsoidalOccluder(m).computeHorizonCullingPointPossiblyUnderEllipsoid(
          f,
          b,
          T,
        ));
    var K = T;
    (K = Math.min(K, Ve(e.westIndices, e.westSkirtHeight, C, M, c, m, v, A, P))),
      (K = Math.min(K, Ve(e.southIndices, e.southSkirtHeight, C, M, c, m, v, A, P))),
      (K = Math.min(K, Ve(e.eastIndices, e.eastSkirtHeight, C, M, c, m, v, A, P))),
      (K = Math.min(K, Ve(e.northIndices, e.northSkirtHeight, C, M, c, m, v, A, P)));
    for (
    ...
    var ce = 1e-4 * (D - W),
      ...
      ge = o * J;
    return (
      _e($, ge, U, Z, C, M, a, m, c, e.westSkirtHeight, g, r, n, he, 0),
      _e(
        $,
      ...
      Ce.addSkirtIndices(U, q, j, Q, o, de, e.indices.length),
