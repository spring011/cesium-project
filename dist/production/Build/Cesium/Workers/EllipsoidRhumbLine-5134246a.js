define([
  ...
  function C(t, i) {
    if (0 === t) return Math.log(Math.tan(0.5 * (_.CesiumMath.PI_OVER_TWO + i)));
    var e = t * Math.sin(i);
    return (
  ...
  var f = new g.Cartesian3(),
    P = new g.Cartesian3();
  function n(t, i, e, a) {
    g.Cartesian3.normalize(a.cartographicToCartesian(i, P), f),
      g.Cartesian3.normalize(a.cartographicToCartesian(e, P), P);
    var n,
      s,
      h,
      u,
    ...
    (t._ellipticitySquared = (c - m) / c),
      ...
      (t._start.height = 0),
      (t._end = g.Cartographic.clone(e, t._end)),
      (t._end.height = 0),
      (t._heading =
        ((n = t),
        (s = i.longitude),
      ...
      (t._distance = (function (t, i, e, a, n, s, h) {
        var u = t._heading,
          r = s - a,
          o = 0;
        if (
          _.CesiumMath.equalsEpsilon(Math.abs(u), _.CesiumMath.PI_OVER_TWO, _.CesiumMath.EPSILON8)
        )
          if (i === e) o = i * Math.cos(n) * _.CesiumMath.negativePiToPi(r);
          else {
            var l = Math.sin(n);
            o =
  ...
  function M(t, i, e, a, n, s) {
    ...
    if (Math.abs(_.CesiumMath.PI_OVER_TWO - Math.abs(i)) > _.CesiumMath.EPSILON8) {
      ...
      var M;
      if (((u = t.latitude), 0 === n)) M = a * Math.cos(t.latitude);
      else {
  ...
  function c(t, i, e) {
    ...
    (this._ellipsoid = a),
      ...
      m.defined(t) && m.defined(i) && n(this, t, i, a);
  }
  Object.defineProperties(c.prototype, {
    ...
    (c.fromStartHeadingDistance = function (t, i, e, a, n) {
      var s = m.defaultValue(a, g.Ellipsoid.WGS84),
        h = s.maximumRadius,
        u = s.minimumRadius,
        r = h * h,
        o = u * u,
        l = Math.sqrt((r - o) / r),
        d = M(t, (i = _.CesiumMath.negativePiToPi(i)), e, s.maximumRadius, l);
      return !m.defined(n) || (m.defined(a) && !a.equals(n.ellipsoid))
        ? new c(t, d, s)
    ...
    (c.prototype.findIntersectionWithLongitude = function (t, i) {
      ...
      if (
        ...
        _.CesiumMath.equalsEpsilon(Math.abs(t), Math.PI, _.CesiumMath.EPSILON14) &&
      ...
      if (
        ...
        return (
          (i.longitude = t),
          (i.latitude = _.CesiumMath.PI_OVER_TWO * _.CesiumMath.sign(_.CesiumMath.PI_OVER_TWO - a)),
          (i.height = 0),
          i
        );
      }
      var h,
        ...
        o =
          ...
          Math.exp((t - s.longitude) / Math.tan(a)),
        l = (1 + r) / (1 - r),
        d = s.latitude;
      do {
        h = d;
    ...
    (c.prototype.findIntersectionWithLatitude = function (t, i) {
      var e = this._ellipticity,
        ...
        n = this._start;
      if (
        !_.CesiumMath.equalsEpsilon(Math.abs(a), _.CesiumMath.PI_OVER_TWO, _.CesiumMath.EPSILON8)
      ) {
        var s = C(e, n.latitude),
          h = C(e, t),
          u = Math.tan(a) * (h - s),
