define([
  ...
  var R = {
      computeHierarchyPackedLength: function (e) {
        for (var t = 0, r = [e]; 0 < r.length; ) {
          ...
          if (I.defined(i)) {
            ...
            var n = i.positions,
              a = i.holes;
            if ((I.defined(n) && (t += n.length * E.Cartesian3.packedLength), I.defined(a)))
        ...
        for (var i = [e]; 0 < i.length; ) {
          ...
          if (I.defined(n)) {
            ...
            if (
              ...
              for (var s = a.length, u = 0; u < s; ++u, r += 3) E.Cartesian3.pack(a[u], t, r);
      ...
      unpackPolygonHierarchy: function (e, t) {
        for (
          var r = e[t++], i = e[t++], n = new Array(r), a = 0 < i ? new Array(i) : void 0, o = 0;
          o < r;
        ...
        if (!((l = L.arrayRemoveDuplicates(l, E.Cartesian3.equalsEpsilon, !0)).length < 3)) {
          ...
          for (i = 0; i < h; i++) {
            ...
            if (!((f = L.arrayRemoveDuplicates(f, E.Cartesian3.equalsEpsilon, !0)).length < 3)) {
              o.push(f);
              var p = 0;
              for (I.defined(c.holes) && (p = c.holes.length), n = 0; n < p; n++)
                s.enqueue(c.holes[n]);
            }
          }
          o.push(l);
          ...
          if (I.defined(f)) {
            ...
            for (s = 0; s < v; s++) {
              ...
              if (!((b = L.arrayRemoveDuplicates(b, E.Cartesian3.equalsEpsilon, !0)).length < 3)) {
                var w = t(b);
                if (I.defined(w)) {
                  (d = D.PolygonPipeline.computeWindingOrder2D(w)) === D.WindingOrder.CLOCKWISE &&
                    ...
                    (f = f.concat(w));
                  var T = 0;
                  for (I.defined(C.holes) && (T = C.holes.length), y = 0; y < T; y++)
                    o.enqueue(C.holes[y]);
                }
              }
            }
  ...
  (R.computeWallGeometry = function (e, t, r, i, n) {
      ...
      for (o = 3 * (p + h), a = new Array(2 * o), s = 0; s < h; s++) {
        ...
        (u = e[s]),
          ...
          n === M.ArcType.GEODESIC
            ...
            : n === M.ArcType.RHUMB && (d = R.subdivideRhumbLine(t, u, l, f, k));
    ...
    for (h /= 6, s = 0; s < h; s++) {
      ...
      (u = E.Cartesian3.fromArray(a, 3 * C, z)),
        ...
        E.Cartesian3.equalsEpsilon(u, l, x.CesiumMath.EPSILON10, x.CesiumMath.EPSILON10) ||
          ((v[m++] = C), (v[m++] = w), (v[m++] = b), (v[m++] = b), (v[m++] = w), (v[m++] = T));
    }
