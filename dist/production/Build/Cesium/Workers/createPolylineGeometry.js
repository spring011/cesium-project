define([
  ...
  function m(e) {
    ...
    (this._positions = t),
      ...
      (this._granularity = J.defaultValue(e.granularity, j.CesiumMath.RADIANS_PER_DEGREE)),
      (this._ellipsoid = K.Ellipsoid.clone(J.defaultValue(e.ellipsoid, K.Ellipsoid.WGS84))),
      (this._workerName = 'createPolylineGeometry');
    var n = 1 + t.length * K.Cartesian3.packedLength;
    (n += J.defined(r) ? 1 + r.length * oe.Color.packedLength : 1),
      (this.packedLength = n + K.Ellipsoid.packedLength + y.VertexFormat.packedLength + 4);
  }
      ...
      if (!(u < 2 || o <= 0)) {
        if (s === re.ArcType.GEODESIC || s === re.ArcType.RHUMB) {
          ...
          m =
            s === re.ArcType.GEODESIC
              ? ((y = j.CesiumMath.chordLength(p, d.maximumRadius)),
        ...
        for (r = 0; r < u; ++r) {
          ...
          0 === r
            ...
            J.defined(F) && ((S = 0 === r || l ? i[r] : i[r - 1]), r !== u - 1 && (B = i[r]));
          var U = r === u - 1 ? 2 : 4;
          for (a = 0 === r ? 2 : 0; a < U; ++a) {
            K.Cartesian3.pack(se, x, G),
              K.Cartesian3.pack(pe, k, G),
              K.Cartesian3.pack(de, D, G),
              (G += 3);
            var N = a - 2 < 0 ? -1 : 1;
            if (
              ((V[O++] = (a % 2) * 2 - 1),
              (V[O++] = N * o),
              n.st && ((L[R++] = r / (u - 1)), (L[R++] = Math.max(V[O - 2], 0))),
              J.defined(F))
            ) {
              var M = a < 2 ? S : B;
