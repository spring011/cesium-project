    ...
    function newContext(u) {
      ...
      function w(e) {
        ...
        return (
          ...
          isArray(t) &&
          1 < t.length &&
          (t.shift(), l.require.undef(e), l.makeRequire(null, { skipMap: !0 })([e]), 1)
        );
      }
      function y(e) {
        var t,
      ...
      return (
                  ...
                  if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
                    ...
                    (this.exports = n),
                      this.map.isDefine &&
                        !this.ignore &&
                        ((m[i] = n),
                        req.onResourceLoad && req.onResourceLoad(l, this.map, this.depMaps)),
                      P(i),
                      (this.defined = !0);
                  }
                  (this.defining = !1),
        ...
        ((l = {
          ...
          completeLoad: function (e) {
            ...
            if (
              ((l.defQueueMap = {}), (r = getOwn(p, e)), !t && !hasProp(m, e) && r && !r.inited)
            ) {
          ...
          nameToUrl: function (e, t, i) {
            ...
            if (req.jsExtRegExp.test(e)) a = e + (t || '');
              ...
              (a = n.join('/')),
                (a =
                  ('/' === (a += t || (/^data\:|\?/.test(a) || i ? '' : '.js')).charAt(0) ||
                  a.match(/^[\w\+\.\-]+:/)
                    ? ''
                    : g.baseUrl) + a);
            }
            return g.urlArgs ? a + ((-1 === a.indexOf('?') ? '?' : '&') + g.urlArgs) : a;
          },
          load: function (e, t) {
            req.load(l, e, t);
          },
          ...
          onScriptError: function (e) {
            var t = s(e);
            if (!w(t.id))
              return O(makeError('scripterror', 'Script error for: ' + t.id, e, [t.id]));
          },
