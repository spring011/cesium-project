...
], function (e, C, A, w, E, O, M) {
  'use strict';
  var i = {};
  var b = new w.Cartographic(),
  ...
  (i.computePositions = function (e, i, t, n, r, o) {
      ...
      if (!(r < 2)) {
        ...
        for (var P, u, c = 1, v = 1; v < r; ++v) {
          ...
          a && (y.height = t[v]),
            ...
            (P = p),
            (u = y),
            A.CesiumMath.equalsEpsilon(P.latitude, u.latitude, A.CesiumMath.EPSILON14) &&
            A.CesiumMath.equalsEpsilon(P.longitude, u.longitude, A.CesiumMath.EPSILON14)
              ? p.height < y.height && (s[c - 1] = y.height)
              : ((h[c] = f),
                (s[c] = y.height),
                (g[c] = o ? n[v] : 0),
                w.Cartographic.clone(y, p),
                ++c);
        }
        if (!(l || c < 2))
          return (
    ...
    if (C.defined(a)) {
      if (((i = a.positions), (t = a.topHeights), (n = a.bottomHeights), 3 <= i.length)) {
        ...
        O.PolygonPipeline.computeWindingOrder2D(l) === O.WindingOrder.CLOCKWISE &&
      ...
      var h,
        ...
        g = i.length,
        d = g - 2,
        p = A.CesiumMath.chordLength(r, e.maximumRadius),
        P = T;
      if (((P.minDistance = p), (P.ellipsoid = e), o)) {
        ...
        for (u = 0; u < g - 1; u++) {
          ...
          h.set(m, y),
            (f[0] = n[u]),
            (f[1] = n[u + 1]),
            s.set(M.PolylinePipeline.generateArc(P), y),
            (y += m.length);
        }
      } else
        (P.positions = i),
          (P.height = t),
          (h = new Float64Array(M.PolylinePipeline.generateArc(P))),
          (P.height = n),
          (s = new Float64Array(M.PolylinePipeline.generateArc(P)));
