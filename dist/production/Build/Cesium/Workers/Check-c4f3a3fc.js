define(['exports', './when-c2e8ef35'], function (e, n) {
  ...
  (f.typeOf = {}),
    ...
    (f.typeOf.number.lessThan = function (e, t, n) {
      if ((f.typeOf.number(e, t), n <= t))
        throw new r('Expected ' + e + ' to be less than ' + n + ', actual value was ' + t);
    }),
    ...
    (f.typeOf.number.greaterThan = function (e, t, n) {
      if ((f.typeOf.number(e, t), t <= n))
        throw new r('Expected ' + e + ' to be greater than ' + n + ', actual value was ' + t);
    }),
