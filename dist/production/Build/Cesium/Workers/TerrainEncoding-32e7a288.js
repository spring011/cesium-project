define([
  ...
  (i.prototype.isScaledSpacePointVisiblePossiblyUnderEllipsoid = function (t, e) {
    var i,
      r,
      a = this._ellipsoid;
    return (
  ...
  (i.prototype.computeHorizonCullingPointPossiblyUnderEllipsoid = function (t, e, i, r) {
    return d(u(this._ellipsoid, i, o), t, e, r);
  }),
    (i.prototype.computeHorizonCullingPointFromVertices = function (t, e, i, r, a) {
  ...
  i.prototype.computeHorizonCullingPointFromRectangle = function (t, e, i) {
    var r = b.Rectangle.subsample(t, e, 0, c),
  ...
  function u(t, e, i) {
    if (y.defined(e) && e < 0 && t.minimumRadius > -e) {
      var r = b.Cartesian3.fromElements(t.radii.x + e, t.radii.y + e, t.radii.z + e, a);
  ...
  function p(t, e, i, r, a, n) {
    ...
    for (var o = T(t, e), s = 0, m = 0, c = i.length; m < c; m += r) {
  ...
  function h(t, e, i) {
    var r = e,
      a = i,
      n = b.Cartesian3.subtract(t, r, m),
      o = -b.Cartesian3.dot(n, r);
    return !(a < 0 ? 0 < o : a < o && (o * o) / b.Cartesian3.magnitudeSquared(n) > a);
  }
  ...
  function M(t, e, i) {
    ...
    return (
      ...
      (b.Cartesian3.dot(o, i) * s -
        b.Cartesian3.magnitude(b.Cartesian3.cross(o, i, o)) * (Math.sqrt(a - 1) * s))
    );
  }
  function g(t, e, i) {
    if (!(e <= 0 || e === 1 / 0 || e != e)) return b.Cartesian3.multiplyByScalar(t, e, i);
  }
  ...
  function w(t, e, i, r, a, n) {
    ...
    if (y.defined(t) && y.defined(e) && y.defined(i) && y.defined(r)) {
      var u = t.minimum,
        ...
        p = i - e;
      (c = Math.max(b.Cartesian3.maximumComponent(l), p) < _ - 1 ? P.BITS12 : P.NONE),
        (o = t.center),
      ...
      (f.x = 1 / l.x),
        ...
        (m = v.Matrix4.clone(r)),
        v.Matrix4.setTranslation(m, b.Cartesian3.ZERO, m),
  ...
  (w.prototype.encode = function (t, e, i, r, a, n, o) {
    ...
    if (this.quantization === P.BITS12) {
      ((i = v.Matrix4.multiplyByPoint(this.toScaledENU, i, z)).x = f.CesiumMath.clamp(i.x, 0, 1)),
        (i.y = f.CesiumMath.clamp(i.y, 0, 1)),
        (i.z = f.CesiumMath.clamp(i.z, 0, 1));
      var c = this.maximumHeight - this.minimumHeight,
        u = f.CesiumMath.clamp((a - this.minimumHeight) / c, 0, 1);
      ...
      b.Cartesian2.fromElements(s, m, N);
    ...
    (w.prototype.decodePosition = function (t, e, i) {
      if (
        ...
        return (
          (i.x = t[e]), (i.y = t[e + 1]), (i.z = t[e + 2]), b.Cartesian3.add(i, this.center, i)
        );
