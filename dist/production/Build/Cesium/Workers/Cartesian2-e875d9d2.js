define(['exports', './when-c2e8ef35', './Check-c4f3a3fc', './Math-d30358ed'], function (
  e,
  R,
  i,
  V,
  ...
  (b.fromSpherical = function (e, t) {
    ...
    (b.fromCartesian4 = b.clone =
      function (e, t) {
        if (R.defined(e))
          return R.defined(t) ? ((t.x = e.x), (t.y = e.y), (t.z = e.z), t) : new b(e.x, e.y, e.z);
      }),
    (b.packedLength = 3),
  ...
  (b.mostOrthogonalAxis = function (e, t) {
    ...
    (b.equalsEpsilon = function (e, t, n, a) {
      return (
        ...
        (R.defined(e) &&
          R.defined(t) &&
          V.CesiumMath.equalsEpsilon(e.x, t.x, n, a) &&
          V.CesiumMath.equalsEpsilon(e.y, t.y, n, a) &&
          V.CesiumMath.equalsEpsilon(e.z, t.z, n, a))
      );
    }),
    ...
    (b.fromDegrees = function (e, t, n, a, r) {
      return (
        (e = V.CesiumMath.toRadians(e)),
        (t = V.CesiumMath.toRadians(t)),
        b.fromRadians(e, t, n, a, r)
      );
    });
  var d = new b(),
    s = new b(),
    h = new b(40680631590769, 40680631590769, 40408299984661.445);
  (b.fromRadians = function (e, t, n, a, r) {
    ...
    (d.x = u * Math.cos(e)),
      ...
      (d.z = Math.sin(t)),
      (d = b.normalize(d, d)),
      b.multiplyComponents(i, d, s);
    var o = Math.sqrt(b.dot(d, s));
    return (
      (s = b.divideByScalar(s, o, s)),
      (d = b.multiplyByScalar(d, n, d)),
      R.defined(r) || (r = new b()),
      b.add(s, d, r)
    );
  }),
    ...
    (b.ZERO = Object.freeze(new b(0, 0, 0))),
    (b.UNIT_X = Object.freeze(new b(1, 0, 0))),
    (b.UNIT_Y = Object.freeze(new b(0, 1, 0))),
    (b.UNIT_Z = Object.freeze(new b(0, 0, 1))),
  ...
  function l(e, t, n, a, r) {
    ...
    var v,
      ...
      q,
      O,
      T = ((1 - y) * b.magnitude(e)) / (0.5 * b.magnitude(w)),
      A = 0;
    do {
      A =
        (v =
  ...
  (f.fromRadians = function (e, t, n, a) {
    return (
      (n = R.defaultValue(n, 0)),
      R.defined(a) ? ((a.longitude = e), (a.latitude = t), (a.height = n), a) : new f(e, t, n)
    );
  }),
    (f.fromDegrees = function (e, t, n, a) {
      return (
        (e = V.CesiumMath.toRadians(e)), (t = V.CesiumMath.toRadians(t)), f.fromRadians(e, t, n, a)
      );
    });
  var c = new b(),
    m = new b(),
    y = new b(),
    p = new b(1 / 6378137, 1 / 6378137, 1 / 6356752.314245179),
    g = new b(1 / 40680631590769, 1 / 40680631590769, 1 / 40408299984661.445),
    x = V.CesiumMath.EPSILON1;
  function M(e, t, n, a) {
    (t = R.defaultValue(t, 0)),
      (n = R.defaultValue(n, 0)),
      (a = R.defaultValue(a, 0)),
      (e._radii = new b(t, n, a)),
      (e._radiiSquared = new b(t * t, n * n, a * a)),
      (e._radiiToTheFourth = new b(t * t * t * t, n * n * n * n, a * a * a * a)),
      (e._oneOverRadii = new b(0 === t ? 0 : 1 / t, 0 === n ? 0 : 1 / n, 0 === a ? 0 : 1 / a)),
      (e._oneOverRadiiSquared = new b(
        0 === t ? 0 : 1 / (t * t),
        0 === n ? 0 : 1 / (n * n),
        0 === a ? 0 : 1 / (a * a),
      )),
      ...
      (e._centerToleranceSquared = V.CesiumMath.EPSILON1),
  ...
  (f.fromCartesian = function (e, t, n) {
    ...
    (w.clone = function (e, t) {
      if (R.defined(e)) {
        ...
        return R.defined(t)
          ? (b.clone(n, t._radii),
            b.clone(e._radiiSquared, t._radiiSquared),
            b.clone(e._radiiToTheFourth, t._radiiToTheFourth),
            b.clone(e._oneOverRadii, t._oneOverRadii),
            b.clone(e._oneOverRadiiSquared, t._oneOverRadiiSquared),
    ...
    (w.MOON = Object.freeze(
      new w(V.CesiumMath.LUNAR_RADIUS, V.CesiumMath.LUNAR_RADIUS, V.CesiumMath.LUNAR_RADIUS),
    )),
    (w.prototype.clone = function (e) {
      return w.clone(this, e);
    }),
    (w.packedLength = b.packedLength),
    ...
    (w.prototype.geocentricSurfaceNormal = b.normalize),
    ...
    (w.prototype.geodeticSurfaceNormal = function (e, t) {
      return (
        R.defined(t) || (t = new b()),
        (t = b.multiplyComponents(e, this._oneOverRadiiSquared, t)),
        b.normalize(t, t)
      );
    });
  var v = new b(),
  ...
  (w.prototype.cartographicToCartesian = function (e, t) {
    ...
    return (
      b.divideByScalar(a, r, a),
      b.multiplyByScalar(n, e.height, n),
      R.defined(t) || (t = new b()),
      b.add(a, n, t)
    );
  }),
  ...
  (w.prototype.cartesianToCartographic = function (e, t) {
    ...
    if (R.defined(n)) {
      var a = this.geodeticSurfaceNormal(n, C),
        ...
        u = Math.asin(a.z),
        o = V.CesiumMath.sign(b.dot(r, e)) * b.magnitude(r);
      return R.defined(t)
    ...
    (q.fromDegrees = function (e, t, n, a, r) {
      return (
        (e = V.CesiumMath.toRadians(R.defaultValue(e, 0))),
        (t = V.CesiumMath.toRadians(R.defaultValue(t, 0))),
        (n = V.CesiumMath.toRadians(R.defaultValue(n, 0))),
        (a = V.CesiumMath.toRadians(R.defaultValue(a, 0))),
        R.defined(r)
    ...
    (q.fromCartographicArray = function (e, t) {
      ...
      return (
        i - r < a - n &&
          ((n = r),
          (a = i) > V.CesiumMath.PI && (a -= V.CesiumMath.TWO_PI),
          n > V.CesiumMath.PI && (n -= V.CesiumMath.TWO_PI)),
        R.defined(t)
    ...
    (q.fromCartesianArray = function (e, t, n) {
      ...
      return (
        u - i < r - a &&
          ((a = i),
          (r = u) > V.CesiumMath.PI && (r -= V.CesiumMath.TWO_PI),
          a > V.CesiumMath.PI && (a -= V.CesiumMath.TWO_PI)),
        R.defined(n)
    ...
    (q.center = function (e, t) {
      ...
      var r = V.CesiumMath.negativePiToPi(0.5 * (a + n)),
    ...
    (q.intersection = function (e, t, n) {
      var a = e.east,
        ...
        i = t.east,
        u = t.west;
      a < r && 0 < i ? (a += V.CesiumMath.TWO_PI) : i < u && 0 < a && (i += V.CesiumMath.TWO_PI),
        a < r && u < 0 ? (u += V.CesiumMath.TWO_PI) : i < u && r < 0 && (r += V.CesiumMath.TWO_PI);
      var o = V.CesiumMath.negativePiToPi(Math.max(r, u)),
        d = V.CesiumMath.negativePiToPi(Math.min(a, i));
    ...
    (q.contains = function (e, t) {
      var n = t.longitude,
        ...
        i = e.east;
      return (
        i < r && ((i += V.CesiumMath.TWO_PI), n < 0 && (n += V.CesiumMath.TWO_PI)),
        (r < n || V.CesiumMath.equalsEpsilon(n, r, V.CesiumMath.EPSILON14)) &&
          (n < i || V.CesiumMath.equalsEpsilon(n, i, V.CesiumMath.EPSILON14)) &&
          a >= e.south &&
          a <= e.north
      );
    });
  ...
  (q.subsample = function (e, t, n, a) {
    ...
    for (var h = 1; h < 8; ++h)
      (s.longitude = -Math.PI + h * V.CesiumMath.PI_OVER_TWO),
    ...
    (q.MAX_VALUE = Object.freeze(
      new q(-Math.PI, -V.CesiumMath.PI_OVER_TWO, Math.PI, V.CesiumMath.PI_OVER_TWO),
    )),
    (T.fromElements = function (e, t, n) {
      return R.defined(n) ? ((n.x = e), (n.y = t), n) : new T(e, t);
    }),
    (T.fromCartesian3 = T.clone =
      function (e, t) {
    ...
    (T.unpack = function (e, t, n) {
      return (
        (t = R.defaultValue(t, 0)), R.defined(n) || (n = new T()), (n.x = e[t++]), (n.y = e[t]), n
      );
    }),
