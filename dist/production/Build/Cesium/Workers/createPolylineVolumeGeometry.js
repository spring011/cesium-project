define([
...
], function (u, e, i, c, G, t, n, A, R, D, r, I, a, O, o, l, g, s, d, p, y, S, m, h, f) {
  'use strict';
  var v = {};
  function B(e, t) {
  ...
  function b(e) {
    var t = (e = u.defaultValue(e, u.defaultValue.EMPTY_OBJECT)).polylinePositions,
      n = e.shapePositions;
    (this._positions = t),
      (this._shape = n),
      (this._ellipsoid = c.Ellipsoid.clone(u.defaultValue(e.ellipsoid, c.Ellipsoid.WGS84))),
      (this._cornerType = u.defaultValue(e.cornerType, m.CornerType.ROUNDED)),
      (this._vertexFormat = g.VertexFormat.clone(
        u.defaultValue(e.vertexFormat, g.VertexFormat.DEFAULT),
      )),
      (this._granularity = u.defaultValue(e.granularity, i.CesiumMath.RADIANS_PER_DEGREE)),
      (this._workerName = 'createPolylineVolumeGeometry');
    var r = 1 + t.length * c.Cartesian3.packedLength;
    (r += 1 + n.length * c.Cartesian2.packedLength),
      (this.packedLength = r + c.Ellipsoid.packedLength + g.VertexFormat.packedLength + 2);
  }
  (B.geometryOutlines =
    ...
    (b.pack = function (e, t, n) {
      ...
      var i = e._positions,
        a = i.length;
      for (t[n++] = a, r = 0; r < a; ++r, n += c.Cartesian3.packedLength)
        c.Cartesian3.pack(i[r], t, n);
      var o = e._shape;
      for (a = o.length, t[n++] = a, r = 0; r < a; ++r, n += c.Cartesian2.packedLength)
        c.Cartesian2.pack(o[r], t, n);
      return (
        c.Ellipsoid.pack(e._ellipsoid, t, n),
  ...
  var E = c.Ellipsoid.clone(c.Ellipsoid.UNIT_SPHERE),
  ...
  return (
    (b.createGeometry = function (e) {
      var t = e._positions,
        n = s.arrayRemoveDuplicates(t, c.Cartesian3.equalsEpsilon),
        r = e._shape;
      if (
        ...
        return (function (e, t, n, r) {
          ...
          if (r.st || r.tangent || r.bitangent) {
            var b,
              ...
              C = 0;
            for (a = 0; a < g; a++) {
              for (b = a * _, E = x * (t[0].y + k), P[C++] = b, P[C++] = E, o = 1; o < u; o++)
                (E = x * (t[o].y + k)), (P[C++] = b), (P[C++] = E), (P[C++] = b), (P[C++] = E);
              (E = x * (t[0].y + k)), (P[C++] = b), (P[C++] = E);
            }
            for (o = 0; o < u; o++) (b = 0), (E = x * (t[o].y + k)), (P[C++] = b), (P[C++] = E);
            for (o = 0; o < u; o++)
              (b = (g - 1) * _), (E = x * (t[o].y + k)), (P[C++] = b), (P[C++] = E);
