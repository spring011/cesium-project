define([
...
], function (v, e, E, f, A, t, i, _, G, L, r, T, o, H, n, a, C, O, l, D, x, s, I, w) {
  'use strict';
  var S = [],
    k = [];
  function R(e, t, i, r, o) {
    ...
    if (r)
      ...
      if (o === x.ArcType.GEODESIC)
        for (a = 0; a < s; a++)
          d += w.PolygonGeometryLibrary.subdivideLineCount(t[a], t[(a + 1) % s], i);
      else if (o === x.ArcType.RHUMB)
        for (a = 0; a < s; a++)
          d += w.PolygonGeometryLibrary.subdivideRhumbLineCount(e, t[a], t[(a + 1) % s], i);
      for (n = new Float64Array(3 * d), a = 0; a < s; a++) {
        var f;
        o === x.ArcType.GEODESIC
          ? (f = w.PolygonGeometryLibrary.subdivideLine(t[a], t[(a + 1) % s], i, k))
          : o === x.ArcType.RHUMB &&
            (f = w.PolygonGeometryLibrary.subdivideRhumbLine(e, t[a], t[(a + 1) % s], i, k));
  ...
  function N(e, t, i, r, o) {
    ...
    if (r)
      ...
      for (n = new Float64Array(3 * f * 2), a = 0; a < s; ++a) {
        ...
        (y[a] = u / 3),
          o === x.ArcType.GEODESIC
            ? (c = w.PolygonGeometryLibrary.subdivideLine(t[a], t[(a + 1) % s], i, k))
            : o === x.ArcType.RHUMB &&
              (c = w.PolygonGeometryLibrary.subdivideRhumbLine(e, t[a], t[(a + 1) % s], i, k));
  ...
  function c(e) {
    var t = e.polygonHierarchy,
      i = v.defaultValue(e.ellipsoid, f.Ellipsoid.WGS84),
    ...
    (this._ellipsoid = f.Ellipsoid.clone(i)),
      (this._granularity = r),
      (this._height = l),
      ...
      (this.packedLength =
        w.PolygonGeometryLibrary.computeHierarchyPackedLength(t) + f.Ellipsoid.packedLength + 8);
  }
  c.pack = function (e, t, i) {
    return (
      (i = v.defaultValue(i, 0)),
      (i = w.PolygonGeometryLibrary.packPolygonHierarchy(e._polygonHierarchy, t, i)),
      f.Ellipsoid.pack(e._ellipsoid, t, i),
      (i += f.Ellipsoid.packedLength),
      (t[i++] = e._height),
  ...
  var g = f.Ellipsoid.clone(f.Ellipsoid.UNIT_SPHERE),
    h = { polygonHierarchy: {} };
  return (
    (c.unpack = function (e, t, i) {
      ...
      var n = e[t++],
        ...
        d = e[t];
      return (
        v.defined(i) || (i = new c(h)),
        (i._polygonHierarchy = r),
        (i._ellipsoid = f.Ellipsoid.clone(o, i._ellipsoid)),
        (i._height = n),
        (i._extrudedHeight = a),
        (i._granularity = l),
    ...
    (c.createGeometry = function (e) {
      ...
      if (0 !== a.length) {
        ...
        if (
          ...
          !E.CesiumMath.equalsEpsilon(d, f, 0, E.CesiumMath.EPSILON2)
        )
          for (y = 0; y < a.length; y++) {
            if (
              (((l = N(t, a[y], p, o, n)).geometry =
                w.PolygonGeometryLibrary.scaleToGeodeticHeightExtruded(l.geometry, d, f, t, o)),
              ...
              (g =
                e._offsetAttribute === C.GeometryOffsetAttribute.TOP
                  ? C.arrayFill(g, 1, 0, c / 2)
                  : ((s = e._offsetAttribute === C.GeometryOffsetAttribute.NONE ? 0 : 1),
                    C.arrayFill(g, s))),
          ...
          for (y = 0; y < a.length; y++) {
            if (
              (((l = R(t, a[y], p, o, n)).geometry.attributes.position.values =
                I.PolygonPipeline.scaleToGeodeticHeight(
    ...
    function (e, t) {
      return (
        v.defined(t) && (e = c.unpack(e, t)),
        (e._ellipsoid = f.Ellipsoid.clone(e._ellipsoid)),
        c.createGeometry(e)
      );
    }
  );
