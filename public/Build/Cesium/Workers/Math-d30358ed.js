define(['exports', './when-c2e8ef35', './Check-c4f3a3fc'], function (t, r, n) {
  'use strict';
  function i(t) {
  ...
  (i.prototype.init_genrand = function (t) {
  ...
  (h.sign = r.defaultValue(Math.sign, function (t) {
    ...
    (h.toSNorm = function (t, n) {
      return (n = r.defaultValue(n, 255)), Math.round((0.5 * h.clamp(t, -1, 1) + 0.5) * n);
    }),
    (h.fromSNorm = function (t, n) {
      return (n = r.defaultValue(n, 255)), (h.clamp(t, 0, n) / n) * 2 - 1;
    }),
    (h.normalize = function (t, n, i) {
      return 0 === (i = Math.max(i - n, 0)) ? 0 : h.clamp((t - n) / i, 0, 1);
    }),
    ...
    (h.zeroToTwoPi = function (t) {
      ...
      return Math.abs(n) < h.EPSILON14 && Math.abs(t) > h.EPSILON14 ? h.TWO_PI : n;
    }),
    (h.mod = function (t, n) {
      return ((t % n) + n) % n;
    }),
    (h.equalsEpsilon = function (t, n, i, a) {
      a = r.defaultValue(a, i);
      var e = Math.abs(t - n);
      return e <= a || e <= i * Math.max(Math.abs(t), Math.abs(n));
    }),
    (h.lessThan = function (t, n, i) {
      return t - n < -i;
    }),
    (h.lessThanOrEquals = function (t, n, i) {
      return t - n < i;
    }),
    (h.greaterThan = function (t, n, i) {
      return i < t - n;
    }),
    (h.greaterThanOrEquals = function (t, n, i) {
      return -i < t - n;
    });
  var u = [1];
  (h.factorial = function (t) {
    var n = u.length;
    if (n <= t)
      for (var i = u[n - 1], a = n; a <= t; a++) {
        var e = i * a;
        u.push(e), (i = e);
      }
    return u[t];
  }),
    (h.incrementWrap = function (t, n, i) {
      return (i = r.defaultValue(i, 0)), n < ++t && (t = i), t;
    }),
    ...
    (h.clamp = function (t, n, i) {
      return t < n ? n : i < t ? i : t;
    });
  var a = new i();
  (h.setRandomNumberSeed = function (t) {
    ...
    (h.fastApproximateAtan2 = function (t, n) {
      var i,
        a,
        e = Math.abs(t);
      (i = Math.abs(n)), (a = Math.max(e, i));
      var r = (i = Math.min(e, i)) / a;
      return (
