define([
...
], function (e, v, t, u, P, k, C, w, b, A, c) {
  'use strict';
  function m(e, t, r) {
  ...
  function x(e) {
    ...
    if (
      (!(function (e, t, r) {
        ...
        if (i)
          for (n = 0; n < o; ++n)
            v.defined(e[n].geometry) && b.GeometryPipeline.transformToWorldCoordinates(e[n]);
        else P.Matrix4.multiplyTransformation(t, e[0].modelMatrix, t);
      })(n, p, a),
      !a)
    )
      for (t = 0; t < f; ++t) v.defined(n[t].geometry) && b.GeometryPipeline.splitLongitude(n[t]);
    if (
      (!(function (e) {
      ...
      for (t = 0; t < f; ++t) {
        var u = n[t];
        v.defined(u.geometry)
          ? (b.GeometryPipeline.reorderForPostVertexCache(u.geometry),
            b.GeometryPipeline.reorderForPreVertexCache(u.geometry))
          : v.defined(u.westHemisphereGeometry) &&
            v.defined(u.eastHemisphereGeometry) &&
            (b.GeometryPipeline.reorderForPostVertexCache(u.westHemisphereGeometry),
            b.GeometryPipeline.reorderForPreVertexCache(u.westHemisphereGeometry),
            b.GeometryPipeline.reorderForPostVertexCache(u.eastHemisphereGeometry),
    ...
    for (f = c.length, t = 0; t < f; ++t) {
      ...
      if (a)
        ...
        for (m in h)
          if (h.hasOwnProperty(m) && h[m].componentDatatype === k.ComponentDatatype.DOUBLE) {
            var l = m + '3D',
              g = m + '2D';
    ...
    if (!o) {
      var y = [];
      for (f = c.length, t = 0; t < f; ++t)
        (r = c[t]), (y = y.concat(b.GeometryPipeline.fitToUnsignedShortIndices(r)));
      c = y;
    }
    return c;
  }
  ...
  function o(e) {
    ...
    for (var o = 0; o < t; ++o) {
      var a = e[o];
      v.defined(a) ? ((n[i++] = 1), P.BoundingSphere.pack(e[o], n, i)) : (n[i++] = 0),
  ...
  (h.combineGeometry = function (e) {
    ...
    for (var u = new Array(p), c = new Array(p), m = 0; m < p; ++m) {
      var h = d[m],
        l = h.geometry;
      v.defined(l) &&
        ((u[m] = l.boundingSphere),
        (c[m] = l.boundingSphereCV),
        f && (i[m] = h.geometry.offsetAttribute));
      ...
      v.defined(g) &&
        ...
        v.defined(g.boundingSphereCV) &&
          ...
          (c[m] = P.BoundingSphere.union(g.boundingSphereCV, y.boundingSphereCV)));
    }
    return {
      geometries: t,
    ...
    (h.packCreateGeometryResults = function (e, t) {
      ...
      for (var s = 0; s < o; s++) {
        ...
        if (((r[a++] = p ? 1 : 0), p)) {
          ...
          (r[a++] = f) && P.BoundingSphere.pack(d.boundingSphere, r, a),
            (a += P.BoundingSphere.packedLength);
          var u = v.defined(d.boundingSphereCV) ? 1 : 0;
          (r[a++] = u) && P.BoundingSphere.pack(d.boundingSphereCV, r, a),
            (a += P.BoundingSphere.packedLength);
          var c = d.attributes,
            m = [];
          for (var h in c)
    ...
    (h.unpackCreateGeometryResults = function (e) {
      for (
        var t, r = e.stringTable, n = e.packedData, i = new Array(n[0]), o = 0, a = 1;
        a < n.length;
      ...
      for (
        var t = (function (e) {
            for (var t = e, r = new Array(t[0]), n = 0, i = 1; i < t.length; ) {
              ...
              (i += P.Matrix4.packedLength),
                v.defined(t[i]) && (o = { offset: new m(t[i], t[i + 1], t[i + 2]) }),
                (i += 3),
        ...
        for (var a = h.unpackCreateGeometryResults(r[o]), s = a.length, d = 0; d < s; d++) {
          var p = a[d];
          (t[i].geometry = p), ++i;
        }
