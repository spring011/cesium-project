define([
  ...
  (s.fromCartesian4 = function (n, e) {
    var a = o.Cartesian3.fromCartesian4(n, r),
      t = n.w;
  ...
  (s.transform = function (n, e, a) {
    return (
      t.Matrix4.multiplyByPointAsVector(e, n.normal, r),
      o.Cartesian3.normalize(r, r),
      o.Cartesian3.multiplyByScalar(n.normal, -n.distance, l),
      t.Matrix4.multiplyByPoint(e, l, l),
      s.fromPointNormal(l, r, a)
    );
  }),
    (s.clone = function (n, e) {
      return i.defined(e)
        ? (o.Cartesian3.clone(n.normal, e.normal), (e.distance = n.distance), e)
