define([
  ...
  function b(e, t) {
    ...
    var i = e.byteLength;
    if (0 === i || i % 4 != 0)
      throw new S.RuntimeError('The length of key must be greater than 0 and a multiple of 4.');
    var n = new DataView(t),
      r = n.getUint32(0, !0);
    if (r === h || r === c) return t;
    for (
      var a, o = new DataView(e), s = 0, f = t.byteLength, l = f - (f % 8), u = i, d = 8;
      s < l;

    )
      for (a = d = (d + 8) % 24; s < l && a < u; )
        n.setUint32(s, n.getUint32(s, !0) ^ o.getUint32(a, !0), !0),
          n.setUint32(s + 4, n.getUint32(s + 4, !0) ^ o.getUint32(a + 4, !0), !0),
          (s += 8),
          (a += 24);
    if (s < f)
          ...
          function (e, t, i) {
            ...
            var r = {
                ...
                flattenChunks: function (e) {
                  ...
                  for (o = new Uint8Array(n), t = r = 0, i = e.length; t < i; t++)
            ...
            (i.setTyped = function (e) {
              e
                ? ((i.Buf8 = Uint8Array),
                  ...
                  (i.Buf32 = Int32Array),
                  i.assign(i, r))
                : ((i.Buf8 = Array), (i.Buf16 = Array), (i.Buf32 = Array), i.assign(i, a));
            }),
              i.setTyped(n);
          },
          {},
          ...
          function (e, t, i) {
            t.exports = function (e, t) {
              ...
              (i = e.state),
                ...
                (v = (1 << i.distbits) - 1);
              e: do {
                b < 15 && ((c += S[n++] << b), (b += 8), (c += S[n++] << b), (b += 8)),
                  (k = m[c & g]);
                t: for (;;) {
                  if (((c >>>= _ = k >>> 24), (b -= _), 0 === (_ = (k >>> 16) & 255)))
                    T[a++] = 65535 & k;
                  else {
                    if (!(16 & _)) {
                      if (0 == (64 & _)) {
                    ...
                    i: for (;;) {
                      ...
                      if (((c >>>= _), (b -= _), (_ = a - o) < y)) {
                        ...
                        for (; 2 < p; )
                          (T[a++] = E[x++]), (T[a++] = E[x++]), (T[a++] = E[x++]), (p -= 3);
                        p && ((T[a++] = E[x++]), 1 < p && (T[a++] = E[x++]));
                      } else {
                        for (
                          x = a - y;
                          (T[a++] = T[x++]), (T[a++] = T[x++]), (T[a++] = T[x++]), 2 < (p -= 3);
          ...
          function (e, t, i) {
            ...
            function H(e) {
              if (h) {
                ...
                for (D(N, e.lens, 0, 288, u, 0, e.work, { bits: 9 }), t = 0; t < 32; )
                  e.lens[t++] = 5;
              ...
              return (
                ...
                n >= a.wsize
                  ...
                  : ((r = a.wsize - a.wnext),
                    ...
                    (n -= r)
                      ? (B.arraySet(a.window, t, i - n, n, 0), (a.wnext = n), (a.whave = a.wsize))
                      : ((a.wnext += r),
            ...
            (i.inflateReset = s),
              ...
              (i.inflate = function (e, t) {
                ...
                e: for (;;)
                  switch (i.mode) {
                    case F:
                      ...
                      if (((u -= 4), (y = 8 + (15 & (l >>>= 4))), 0 === i.wbits)) i.wbits = y;
                      else if (y > i.wbits) {
                    ...
                    case 7:
                      if (2048 & i.flags) {
                        ...
                        if (
                          (512 & i.flags && (i.check = Z(i.check, n, c, a)), (s -= c), (a += c), y)
                        )
                          break e;
                    ...
                    case 19:
                      ...
                      if (
                        ...
                        (E = { bits: i.distbits }),
                        (x = D(O, i.lens, i.nlen, i.ndist, i.distcode, 0, i.work, E)),
                        (i.distbits = E.bits),
                        x)
                      ) {
                    ...
                    case 25:
                      ...
                      if (((c = h - f), i.offset > c)) {
                        ...
                        (b = c > i.wnext ? ((c -= i.wnext), i.wsize - c) : i.wnext - c),
                    ...
                    case 27:
                      if (i.wrap) {
                        ...
                        if (
                          ...
                          (e.total_out += h),
                          (i.total += h),
                          h && (e.adler = i.check = (i.flags ? Z : U)(i.check, r, h, o - h)),
                          (h = f),
                ...
                (e.next_out = o),
                  ...
                  (i.hold = l),
                  (i.bits = u),
                  (i.wsize || (h !== e.avail_out && i.mode < 30 && (i.mode < 27 || 4 !== t))) &&
                ...
                (d -= e.avail_in),
                  ...
                  i.wrap &&
                    h &&
                    (e.adler = i.check = (i.flags ? Z : U)(i.check, r, h, e.next_out - h));
                (e.data_type =
                  i.bits +
                  (i.last ? 64 : 0) +
                  (12 === i.mode ? 128 : 0) +
          ...
          function (e, t, i) {
            ...
            (o.prototype.push = function (e, t) {
              ...
              do {
                if (
                  (0 === f.avail_out &&
                    ((f.output = new c.Buf8(l)), (f.next_out = 0), (f.avail_out = l)),
                ...
                f.next_out &&
                  ((0 !== f.avail_out &&
                    i !== m.Z_STREAM_END &&
                    (0 !== f.avail_in || (n !== m.Z_FINISH && n !== m.Z_SYNC_FLUSH))) ||
              ...
              return (
                ...
                n === m.Z_FINISH
                  ? ((i = h.inflateEnd(this.strm)), this.onEnd(i), (this.ended = !0), i === m.Z_OK)
                  : n !== m.Z_SYNC_FLUSH || (this.onEnd(m.Z_OK), !(f.avail_out = 0))
              );
            }),
    ...
    switch (i) {
      case o.METADATA:
        return (function (e, t, i) {
          ...
          if (((r += B), 1 !== o))
            throw new S.RuntimeError('Invalid data type. Must be 1 for QuadTreePacket');
