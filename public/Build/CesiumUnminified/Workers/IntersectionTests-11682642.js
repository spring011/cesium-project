...
define([
  ...
  './Cartesian2-a4e73c05',
  './Transforms-533d1994',
], function (exports, when, Check, _Math, Cartesian2, Transforms) {
  'use strict';
  ...
  QuadraticRealPolynomial.computeRealRoots = function (a, b, c) {
    ...
    if (a === 0.0) {
      ...
      if (cMagnitude < aMagnitude && cMagnitude / aMagnitude < _Math.CesiumMath.EPSILON14) {
        // c ~= 0.0.
        // 2nd order monomial: a * x^2 = 0.
        return [0.0, 0.0];
      } else if (cMagnitude > aMagnitude && aMagnitude / cMagnitude < _Math.CesiumMath.EPSILON14) {
        // a ~= 0.0.
        // Constant function: c = 0.
        return [];
      }
  ...
  function Ray(origin, direction) {
    direction = Cartesian2.Cartesian3.clone(
      when.defaultValue(direction, Cartesian2.Cartesian3.ZERO),
    );
     ...
     */
    this.origin = Cartesian2.Cartesian3.clone(
      when.defaultValue(origin, Cartesian2.Cartesian3.ZERO),
    );
  ...
  function quadraticVectorExpression(A, b, c, x, w) {
    ...
    var r0 =
      ...
      (x *
        addWithCancellationCheck$1(
          A[Transforms.Matrix3.COLUMN2ROW0],
          A[Transforms.Matrix3.COLUMN0ROW2],
        ) +
        b.z);
  ...
  IntersectionTests.grazingAltitudeLocation = function (ray, ellipsoid) {
    ...
    var A = Transforms.Matrix3.multiply(
      Transforms.Matrix3.multiply(temp, D_I, aScratch),
      B,
      aScratch,
    );
